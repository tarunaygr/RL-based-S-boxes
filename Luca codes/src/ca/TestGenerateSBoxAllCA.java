...
/**
 * Build the S-boxes corresponding to all CA of diameter d of a specified length
 * and compute their nonlinearity and differential uniformity
 * 
 * @author Luca Mariot
 */
...
public class TestGenerateSBoxAllCA {
    ...
    public static void main(String[] args) {
        ...
        //Main cycle: loop over all possible local rules of diameter nbr
        for(int cur=0; cur<nrules; cur++) {
            
            boolean[][] sbox = null;   //Initialize the CA S-box
            
            //Convert the decimal index (Wolfram code) in the truth table of the rule
            boolean[] ttable = BinTools.dec2BinMod(cur, tlength);
            System.out.print("\n__________\n\nRule "+cur+" - Truth table: ");
